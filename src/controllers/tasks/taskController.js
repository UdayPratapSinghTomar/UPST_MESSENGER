...
//     // =========================
//     // 🔁 TRACK INSERTED DATA (for rollback)
//     // =========================
//     let createdProjectId = null;
//     let createdTaskId = null;
...
//       if (projectError) {
//         return sendResponse(res, HttpsStatus.BAD_REQUEST, false, 'Project not created', null, projectError);
//       }
...
//         created_by_user_id: userId,
//         assigned_user_id: assigned_users?.[0] || userId
//       })
//       .select()
//       .single();
...
//     if (taskError) {
//       return sendResponse(res, HttpsStatus.BAD_REQUEST, false, "Task not created!", null, taskError);
//     }
...
//       return sendResponse(res, HttpsStatus.BAD_REQUEST, false, 'Task assignments not created', null, assignError);
//     }
...
//       if (urlError) {
//         return sendEmail(res, HttpsStatus.BAD_REQUEST, false, 'Task urls not created', null, urlError);
//       }
//     }
...
//       const attachData = attachments.map(file => ({
//         task_id: createdTaskId,
//         organization_id: organizationId,
...
//       if (attachError) {
//         return sendEmail(res, HttpsStatus.BAD_REQUEST, false, 'Task attachment not created', null, attachError);
//       }
//     }
...
//     try {
//       if (createdTaskId) {
//         await supabase.from('task_attachments').delete().eq('task_id', createdTaskId);
//         await supabase.from('task_urls').delete().eq('task_id', createdTaskId);
